...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference("Funcionario.count") do
      post funcionarios_url, params: { funcionario: { cargo: @funcionario.cargo, cpf: @funcionario.cpf, nome: @funcionario.nome, rg: @funcionario.rg, secretaria: @funcionario.secretaria, telefone: @funcionario.telefone, unidade: @funcionario.unidade } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { cargo: @funcionario.cargo, cpf: @funcionario.cpf, nome: @funcionario.nome, rg: @funcionario.rg, secretaria: @funcionario.secretaria, telefone: @funcionario.telefone, unidade: @funcionario.unidade } }
